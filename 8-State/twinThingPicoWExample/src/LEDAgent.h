...
class LEDAgent : public Agent, public SwitchObserver, public StateObserver {
public:
	/***
	 * Constructor
	 ...
	 */
	LEDAgent(uint8_t ledGP, uint8_t spstGP, MQTTInterface *interface, LEDState *ledState);
