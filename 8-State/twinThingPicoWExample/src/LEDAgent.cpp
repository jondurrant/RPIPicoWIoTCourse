 ...
 * @param ledState - state object for the device
 */
LEDAgent::LEDAgent(uint8_t ledGP, uint8_t spstGP, MQTTInterface *interface, LEDState *ledState){
	xLedGP  = ledGP;
	xSpstGP = spstGP;
 ...
 */
void LEDAgent::notifyState(uint16_t dirtyCode){
